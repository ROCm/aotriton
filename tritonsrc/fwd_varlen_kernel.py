...
def attn_fwd_varlen(
    ...
    # cu_seqlens_q_start = off_z * 16
    # cu_seqlens_q_end = off_z * 16 + 16
    ...
    # cu_seqlens_k_start = off_z * 16
    # cu_seqlens_k_end = off_z * 16 + 16
    ...
    v_offset = off_h * stride_vh + cu_seqlens_k_start * stride_vk
    ...
    # Shape (batch, num_heads, max_seqlen_q), continuous
