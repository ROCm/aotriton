...
enum AOTRITON_API Gpu : uint64_t {
  ...
  GPU_AMD_ARCH_GFX1170_MOD0 = TRICAT(GpuVendor::kAMD, 0x1170, 0),
  GPU_AMD_ARCH_GFX1171_MOD0 = TRICAT(GpuVendor::kAMD, 0x1171, 0),
  GPU_AMD_ARCH_GFX1172_MOD0 = TRICAT(GpuVendor::kAMD, 0x1172, 0),
