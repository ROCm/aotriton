...
echo "Creating venv at /wkdir/venv"
python3 -m venv /wkdir/venv

echo "Installing torch and triton wheels"
/wkdir/venv/bin/pip install /torch-*.whl /triton-*.whl

echo "Installing dependencies from requirements-tuning.txt"
...
VENV_SCRIPT
  ...
  echo "Created $dir/inpod.create_venv.sh"
else
