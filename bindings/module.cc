    ...
    namespace flash {
      void setup_module(py::module_ &m) {
        ...
        m.def("attn_fwd", &aotriton::v2::flash::attn_fwd,
              ...
              py::arg("out"), py::arg("dropout_p"), py::arg("philox_seed"),
              py::arg("philox_offset"), py::arg("encoded_softmax"),
              py::arg("is_causal"), py::arg("stream") = nullptr);
        m.def("attn_bwd", &aotriton::v2::flash::attn_bwd,
              "Flash Attention Backward Pass", py::arg("q"), py::arg("k"),
              py::arg("v"), py::arg("sm_scale"), py::arg("out"),
              py::arg("dout"), py::arg("dq"), py::arg("dk"), py::arg("dv"),
              py::arg("softmax_lse"), py::arg("delta"), py::arg("dropout_p"),
              py::arg("philox_seed"), py::arg("philox_offset"),
              py::arg("is_causal"), py::arg("stream") = nullptr);
      }
    } // namespace flash
...
#undef EV
  ...
  void def_tensorview(py::module_ &m, const std::string &name) {
    py::class_<aotriton::TensorView<Rank>>(m, name.c_str())
        .def(py::init<intptr_t, std::array<uint64_t, Rank>,
                      std::array<uint64_t, Rank>, aotriton::DType>())
        ...
        .def_property_readonly("data_ptr",
                               &aotriton::TensorView<Rank>::data_ptr)
...
PYBIND11_MODULE(pyaotriton, m) { pyaotriton::setup_module(m); }
