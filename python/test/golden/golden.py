...
Usage:
    python python/test/golden/golden.py --update   # write a local baseline snapshot
    python python/test/golden/golden.py --check    # regenerate and diff against it
...
The snapshot lands in golden/snapshot/ and is NOT committed (see .gitignore and
README.md): it is a transient local baseline for proving a change is output-
neutral, not a frozen reference. See README.md for the full workflow.
"""
