...
- operator.py: build_merged_struct_cfields (operator params-struct union).
- metro.py:    lower_plan / build_metro (MetroPlan -> MetroKernel IR).
- errors.py:   DescriptionError (the front-end diagnostic).

The public surface is re-exported here so `from ...template_instantiation.builder
import build_kernel, DescriptionError, ...` keeps working.
"""
...
from .operator import build_merged_struct_cfields
