...
"""
Metro IR: MetroKernel / ConditionalKernel (codegen-facing).
...
`iter_kernel_slot_names`). The Stage-4 lowering that builds these from a transpiled
@ati.metro_kernel plan lives in builder/metro.py (lower_plan / build_metro).
"""
