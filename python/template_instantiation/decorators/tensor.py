...
"""
The `ati.tensor` argument-binding decorator + its TensorSpec record.

A TensorSpec carries the authoring data for one tensor argument plus the logic to
resolve stride globs and infer rank against a concrete parameter-name list.
"""
