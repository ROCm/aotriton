...
KSRC = '../../modules/flash/kernel/fwd_kernel.py'   # relative to test/ati/
...
def test_kernel_params_from_stub_has_no_annotations():
    ...
    assert [p.name for p in ps] == attn_fwd.__ati_params__
...
def test_source_does_not_import_triton():
    ...
    try:
        ...
        assert attn_fwd.__ati_params__[0] == 'Q'
    finally:
