...
selector to a concrete v3python.autotune Binning class, and wiring the TuneSpec
...
# fields). Mirrors v3python.kernel.ksignature.COMPILER_OPTIONS.
...
class Config:
    ...
    The constructor mirrors triton.Config / the existing v3python.autotune.Config
    ...
    COMPILER_OPTIONS in v3python.kernel.ksignature). So we accept it inside kw for
