...
class FlashOp(TuningDescription):
    ...
    def run_single_test(self, im, pt, which_kernel: FlashOpKernelSelector):
        return self._flash.run_single_test(im, pt, which_kernel)

    def run_single_benchmark(self, im, pt, which_kernel: FlashOpKernelSelector):
